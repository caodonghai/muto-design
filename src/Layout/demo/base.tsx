...
import { Layout } from 'muto-design';
...
export default function () {
  ...
  return (
    <Layout height={400} direction="horizontal">
      <Slider
        size={64}
        bordered
        draggable={true}
      ...
      <Flex direction="vertical">
        ...
        <Slider
          ...
          collapseOptions={{
            draggable: true,
            style: { height: 26 },
            title: (collapsed) => (collapsed ? '展开详情' : '收起详情'),
          }}
        >
          <Comp>
            Layout.Slider3-1
        ...
        <Flex direction="vertical" style={{ overflow: 'hidden' }}>
        ...
        <Slider
          bordered
          size={120}
          resizeOption={{ minSize: 60, maxSize: 300 }}
        >
          <Comp>
            Layout.Slider5
            <br />
